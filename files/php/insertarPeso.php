...
exit();
	...
	$resultado = mysqli_query($con, "INSERT INTO Pesos (peso, idusuario) VALUES ('$peso','$usuario')");
	$resultado1 = mysqli_query($con, "UPDATE Usuarios SET peso='$peso' WHERE usuario='$usuario'");	
